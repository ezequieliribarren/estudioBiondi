  ...
  useEffect(() => {
    const handleClick = (event) => {
      ...
      if (target.classList.contains('serv1')) {
        ...
        Swal.fire({
          html: '<div class="sweet"> <h3 class="titleSweet">¿Qué es el sindrome de ulices?</h3> <ul class= "pSweet">              <li><h5>Asesoramiento y atención a monotributistas, inscripción, recategorización, modificación de datos, bajas</h5></li><li><h5>Asesoramiento y atención a autónomos, inscripción, recategorización, liquidación de impuestos</h5></li><li><h5>Regímenes de retención (SICORE)</h5></li><li><h5>Regímenes de información</h5></li><li><h5>Confección de moratorias y facilidades de pago</h5></li> </ul> </div>',
          width: '100%',
                  backdrop:"true",
                  confirmButtonText: 'Volver',
                  confirmButtonColor: '#1E285F',
        ...
        Swal.fire({
          html: '<div class="sweet"> <h3 class="titleSweet">¿Qué es el sindrome de ulices?</h3> <ul class= "pSweet">                <li><h5>Confección y presentación de declaraciones juradas y boletas de sindicatos</h5></li><li><h5>Emisión de recibos de haberes y registración en el libro sueldos</h5></li><li><h5>Liquidaciones finales</h5></li><li><h5>Inscripciones varias, altas y bajas de empleados, confección de certificados de servicios</h5></li> </div>',
          width: '100%',
                  backdrop:"true",
                  confirmButtonText: 'Volver',
                  confirmButtonColor: '#1E285F',
        ...
        Swal.fire({
          html: '<div class="sweet"> <h3 class="titleSweet">¿Qué es el sindrome de ulices?</h3>  <li><h5>Asesoramiento y atención </h5></li><li><h5>Emision de recibos de haberes</h5></li><li><h5>Emision constancia de pago</h5></li><li><h5>Altas, bajas y modificaciones</h5></li><li><h5>Liquidaciones finales</h5></li> </div>',
          width: '100%',
                  backdrop:"true",
                  confirmButtonText: 'Volver',
                  confirmButtonColor: '#1E285F',
